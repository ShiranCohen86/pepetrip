/** Minimal inline-SVG icon set (Lucide-style) so we ship no icon dependency. */
const ICONS = {
  ...
  wallet: (
    <path d="M19 7V5a2 2 0 0 0-2-2H5a2 2 0 0 0 0 4h14a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5M17 12h.01" />
  ),
  clock: (
    <>
